    ...
    textAngular.directive("textAngular", [
                ...
                return {
                    ...
                    link: function (scope, element, attrs, ngModel) {
                        ...
                        _focusin = function () {
                            if ((element.text() === element.attr('placeholder')) && (element.hasClass('placeholder-text'))) {
                        ...
                        if (element.attr("placeholder")) {
                            ...
                            element.addClass('placeholder-text');
                            element.on('focus', _focusin);
                            element.on('blur', _focusout);
                        }
                ...
                return function (editor) {
                    if (!this.$editor && editor) this.$editor = function () {
                        return editor;
                    };
