...
m.$on("ta-element-select",function(a,b){x.triggerElementSelect(a,b)&&m["reApplyOnSelectorHandlerstaTextElement"+B]()}),m.$on("ta-drop-event",function(a,b,d,e){e&&e.files&&e.files.length>0?(m.displayElements.text[0].focus(),angular.forEach(e.files,function(a){
