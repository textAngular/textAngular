...
m.showPopover=function(a){m.displayElements.popover.css("display","block"),m.reflowPopover(a),i.addClass(m.displayElements.popover,"in"),C(h.find("body"),"click keyup",function(){m.hidePopover()})},m.reflowPopover=function(a){console.log(a[0].offsetTop,a[0].offsetHeight,m.displayElements.text[0].offsetTop,m.displayElements.text[0].offsetHeight,m.displayElements.text[0].getBoundingClientRect()),/* istanbul ignore if: catches only if near bottom of editor */
